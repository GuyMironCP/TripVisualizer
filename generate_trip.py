...
S = {
    ...
    # ── Day 1 · Jul 16 · Feldberg + Badeparadies ──────────────────────────────
    (1,  9): ("🚗 נסיעה לפלדברג\n~20 דק' מהמלון", C_ORANGE),
    (1, 10): ("🌲 הר פלדברג (1493 מ')\nKletterwald + אטרקציות חינם", C_GREEN),
    (1, 11): ("🌲 פלדברג\nFeldbergbahn רכבל לפסגה", C_GREEN),
    (1, 12): ("🌲 פלדברג\nמגדל תצפית + מוזיאונים\nרכיבה על סוסים – חינם!", C_GREEN),
    (1, 13): ("🚗 נסיעה ל-Badeparadies\n~30 דק'", C_ORANGE),
    (1, 14): ("🎢 Badeparadies Schwarzwald\nפארק מים – מגלשות אקסטרים", C_YELLOW),
    (1, 15): ("🎢 Badeparadies\nבריכות טרופיות + מגלשות", C_YELLOW),
    (1, 16): ("🎢 Badeparadies\nמגלשות + Palm Oasis", C_YELLOW),
    (1, 17): ("🎢 Badeparadies\nסאונות + מגלשות", C_YELLOW),
    (1, 18): ("🚗 חזרה למלון\nHofgut Sternen ~20 דק'", C_ORANGE),
    ...
    (2, 17): ("🎢 Europa-Park\nשואו ערב", C_YELLOW),
    (2, 17): ("🚗 נסיעה לפרייבורג\n~35 דק' מ-Rust", C_ORANGE),
    (2, 18): ("🌲 פרייבורג – ערב עיר\nמינסטר + Bächle + ארוחה", C_GREEN),
    (2, 19): ("🌲 פרייבורג\nרחוב ראשי + ערב יום שישי", C_GREEN),
    (2, 20): ("🚗 חזרה למלון\nHofgut Sternen ~55 דק'", C_ORANGE),
...
DAYS = [
    {"date": "15/07", "dow": "יום ד'", "phase": 1},
    {"date": "16/07", "dow": "יום ה'", "phase": 1},
    {"date": "17/07", "dow": "יום ו'", "phase": 1},
    {"date": "18/07", "dow": "שבת",    "phase": 1},
    {"date": "19/07", "dow": "יום א'", "phase": 1},
    {"date": "20/07", "dow": "יום ב'", "phase": 1},
    {"date": "21/07", "dow": "יום ג'", "phase": 2},
    {"date": "22/07", "dow": "יום ד'", "phase": 2},
    {"date": "23/07", "dow": "יום ה'", "phase": 2},
    {"date": "24/07", "dow": "יום ו'", "phase": 2},
    {"date": "25/07", "dow": "שבת",    "phase": 3},
]
